...
const allSongs = [{
  ...
  },
  {
    ...
    artist: "Various",
    duration: "2:40",
    src: "./resources/samjho_na.mp3",
  },
  {
    title: "Safar",
    artist: "MixSingh",
    duration: "3:26",
    src: "./resources/safar.mp3",
  },
  {
    id: 4,
    title: "9:45",
...
const renderSongs = (array) => {
  const songsHTML = userData.songs.map((song) => {
